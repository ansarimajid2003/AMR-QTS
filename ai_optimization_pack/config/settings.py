...
# ============================================================
MR_RSI_PERIOD = 14
MR_RSI_OVERSOLD = 25         # Lowered from 30 for deeper extremes before entry
MR_RSI_OVERBOUGHT = 75       # Raised from 70
MR_BB_PERIOD = 20
MR_BB_STD = 2.25             # Increased from 2.0 to catch better extremes
MR_SL_ATR_MULT = 1.5         # Widened from 1.2
MR_MIN_RR = 1.5
MR_TIME_EXIT_BARS = 24       # Extended from 20 to 24 (6 hours)
